...
import edu.java.domain.jooq.jooqGen.tables.Chatandlink.ChatandlinkPath;
import edu.java.domain.jooq.jooqGen.tables.Linkstackoverflow.LinkstackoverflowPath;
...
public class Link extends TableImpl<LinkRecord> {
    ...
    /**
     * The column <code>public.link.linkid</code>.
     */
    public final TableField<LinkRecord, Long> LINKID = createField(DSL.name("linkid"), SQLDataType.BIGINT.nullable(false), this, "");
    ...
    private transient ChatandlinkPath _chatandlink;

    /**
     * Get the implicit to-many join path to the <code>public.chatandlink</code>
     * table
     */
    public ChatandlinkPath chatandlink() {
        if (_chatandlink == null)
            _chatandlink = new ChatandlinkPath(this, null, Keys.CHATANDLINK__CHATANDLINK_LINKID_FKEY.getInverseKey());
     ...
     * <code>public.linkstackoverflow</code> table
     */
    public LinkstackoverflowPath linkstackoverflow() {
        if (_linkstackoverflow == null)
            _linkstackoverflow = new LinkstackoverflowPath(this, null, Keys.LINKSTACKOVERFLOW__LINKSTACKOVERFLOW_LINKID_FKEY.getInverseKey());
