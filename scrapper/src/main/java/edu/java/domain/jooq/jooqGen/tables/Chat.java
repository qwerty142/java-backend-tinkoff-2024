...
public class Chat extends TableImpl<ChatRecord> {
     ...
     */
    public final TableField<ChatRecord, Long> CHATID = createField(DSL.name("chatid"), SQLDataType.BIGINT.nullable(false), this, "");
    ...
    public ChatandlinkPath chatandlink() {
        if (_chatandlink == null)
            _chatandlink = new ChatandlinkPath(this, null, Keys.CHATANDLINK__CHATANDLINK_CHATID_FKEY.getInverseKey());
